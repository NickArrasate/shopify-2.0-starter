(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[33],{
  ...
  function () {
    ...
    _createClass(StaticSlideshow, [{
      ...
      value: function _positionDots() {
        ...
        if (_Layout__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"].isBreakpoint('XS') && !this.isFullscreen) {
      ...
      value: function _slideshowHeight() {
        if (this.isFullscreen) {
          ...
          if (window.innerWidth > 768){
            this.el.querySelector('.flickity-viewport').style.height = "calc(100vh)";
            // this.el.querySelector('.flickity-viewport').style.height = "calc(100vh - ".concat(offsetHeight, "px)");
            this.container.style.height = "calc(100vh)";
            // this.container.style.height = "calc(100vh - ".concat(offsetHeight, "px)");
          } else {
            this.el.querySelector('.flickity-viewport').style.height = "calc(75vh)";
            // this.el.querySelector('.flickity-viewport').style.height = "calc(100vh - ".concat(offsetHeight, "px)");
            this.container.style.height = "calc(75vh)";
          }
  ...
  //# sourceMappingURL=StaticSlideshow.bundle.js.map?1565631014304